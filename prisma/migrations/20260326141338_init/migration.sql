...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('CONVERSATIONAL', 'CUSTOMER_SERVICE', 'GENERAL', 'NARRATIVE', 'CHARACTERS', 'MEDITATION', 'MOTIVATIONAL', 'PODCAST', 'ADVERTISING', 'VOICEOVER', 'CORPORATE');
...
CREATE TABLE "Generation" (
    ...
    "repetitionPenalty" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
