...
R2_BUCKET_NAME = "audio-lab-cntbabul"
R2_ACCOUNT_ID = "b42119b2272240992ca1a3bbb518520b"
R2_MOUNT_PATH = "/r2"
...
class Chatterbox:
    ...
    def serve(self):
        ...
        @web_app.post("/generate", dependencies=[Depends(verify_api_key)], responses={200: {"content": {"audio/wav": {}}}})
